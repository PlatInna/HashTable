/* HashTable.cpp : https://www.coursera.org/ C ++ Development Fundamentals: Brown Belt, Week 1.
...
struct IntHasher {
    size_t operator()(int value) const {
        // This is a real hash function from libc ++, libstdc ++.
        // To make it work well, std :: unordered_map
        // uses prime numbers for the number of buckets
        return value;
    }
};
